# ZhuWei 创新点：AI Agent 驱动的漏洞源码级分析
...
以下图片路径用于引入后台证明截图。截图内容与当前创新点材料一一对应。

![后台看板：漏洞、产品、源码库、图谱指标](innovation-assets/dashboard.jpg)

![AI Agent 红队增强分析：源码已找到、模型日志、POC/EXP](innovation-assets/ai-agent-analysis-litellm.jpg)

![源码库：Spring Boot affected/latest 源码归档和 MinIO 上传](innovation-assets/source-archive-springboot.jpg)

![Neo4j 图谱：LiteLLM 产品、漏洞、告警、数据源关系](innovation-assets/graph-litellm.jpg)
